        ...
        return Arrays.asList(new Object[][]{
            {
                ...
                spy(BrowserRow.readRow(
                        "somefolder/iphonese/,http://abobrinha.com,1,a,iOS - iPhone SE,220,1013,19,90,8,993,1080,360,3.0,0,12,/body")),
                "http://abobrinha.com,1,a,0,12," +
                     ...
                     "220,220,1013,1013,19,19,90,90,8,8,993,993,0.0,0.0,1080,1080,360,360,/body",
                0f, 0f, "somefolder/android/1.png", "somefolder/iphonese/1.png"
            },
            {
                spy(BrowserRow.readRow(
                ...
                "http://pepino.com,12,SVG,3,19," +
                     ...
                     "226,220,1020,1013,27,19,98,90,17,8,1003,993,0.0,0.0,1080,720,360,360,/a",
                0f, 0f, "result/motog4/12.png", "result/iphonese/12.png"
            },
            {
                spy(BrowserRow.readRow(
                        "result/motog4/,http://pepino.com,12,SVG,Android - MotoG4 - Chrome,226,1020,27,98,17,1003,1080,360,3.0,3,19,/a")),
                ...
                "http://pepino.com,12,SVG,3,19," +
                     "\"Android - MotoG4 - Chrome\",\"iOS - iPhone SE - Safari\",null,null," +
                     "3.0,2.0,result/motog4/12.png,result/iphonese/12.png," +
                     "226,220,1020,1013,27,19,98,90,17,8,1003,993,12345.0,333.0,1080,720,360,360,/a",
                12345f, 333f, "result/motog4/12.png", "result/iphonese/12.png"
            },
            {
                spy(BrowserRow.readRow(
                ...
                "http://abobrinha.com,1,a,0,12," +
                     "\"Android 2.0 - Chrome\",\"iOS - iPhone SE\",null,null," +
                     "3.0,3.0,somefolder/android/1.png,somefolder/iphonese/1.png," +
                     "220,220,1013,1013,19,19,90,90,8,8,993,993,2345.0,123.0,1080,1080,360,360,/a",
                2345f, 123f, "somefolder/android/1.png", "somefolder/iphonese/1.png"
            },
            {
                spy(BrowserRow.readRow(
                ...
                "http://pepino.com,12,SVG,3,19," +
                     "\"Android - MotoG4 - Chrome\",\"iOS - iPhone SE - Safari\",null,null," +
                     "3.0,2.0,result/motog4/12.png,result/iphonese/12.png," +
                     "214,220,1006,1013,11,19,82,90,0,9,983,993,12345.0,333.0,1080,720,360,360,/a",
                12345f, 333f, "result/motog4/12.png", "result/iphonese/12.png"
            },
            {
                spy(BrowserRow.readRow(
                ...
                "http://pepino.com,12,SVG,3,19," +
                     ...
                     "214,-1,1006,-1,11,-1,82,-1,0,-1,983,-1,-1.0,-1.0,1080,-1,360,-1,/a",
                12345f, 333f, "result/motog4/12.png", "result/iphonese/12.png"
            },
            {
                null,
                ...
                "http://pepino.com,12,SVG,3,19," +
                     ...
                     "-1,214,-1,1006,-1,11,-1,82,-1,0,-1,983,-1.0,-1.0,-1,1080,-1,360,/a",
                12345f, 333f, "result/iphonese/12.png", "result/motog4/12.png"
            }
        });
    }
