...
RUN mkdir /app/opencv-2.4.9/build/
...
RUN apk add --update g++ gcc cmake make linux-headers libc-dev clang-dev clang alpine-sdk musl-dev openblas-dev \
                                        ...
                                        pkgconf gsl libavc1394-dev libdc1394-dev \ #libtbb2 libjasper
                                        libtbb@testing libtbb-dev@testing \
                                        python python-dev py-pip py-numpy-dev@testing apache-ant #py-scipy-dev@testing
